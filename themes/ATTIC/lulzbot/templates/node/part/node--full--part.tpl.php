...
/**
 * @file
 * part full theme implementation to display a node.
 */
  ...
  <div class="content"<?php print $content_attributes; ?>>
    ...
    <section id="product" class="product-section">
      <div class="l--constrained">
        ...
        <div class="section-primary">
          <div class="field--item field--field_part_images">
            <div class="product--gallery">
              <?php print render($content['field_part_images']); ?>
            </div>
          </div>
        </div>
        <?php endif; ?>
        ...
        <div class="section-secondary">
          ...
          <?php if (isset($content['field_part_ease_of_use'])) : ?>
            <div class="field--item field--field_part_ease_of_use">
              <?php print render($content['field_part_ease_of_use']); ?>
            </div>
          <?php endif; ?>
          ...
          <div class="product-info clearfix">
            <div class="product-info--primary clearfix">
              ...
              <?php if (isset($content['field_part_compatible_printers'])) : ?>
                <div class="compatibility">
                  <em><?php print t('Works with'); ?>:</em> <?php print render($content['field_part_compatible_printers']); ?>
                </div>
              <?php endif; ?>
            ...
            <?php endif; ?>
            <ul class="accordion">
              <?php if (isset($content['field_part_features'])) : ?>
                <li>
                  ...
                  <div class="accordion-panel">
                    <?php print render($content['field_part_features']); ?>
                  </div>
                </li>
              <?php endif; ?>
              <?php if (isset($content['field_part_specifications'])) : ?>
                <li>
                  ...
                  <div class="accordion-panel">
                    <?php print render($content['field_part_specifications']); ?>
                  </div>
                </li>
              <?php endif; ?>
              <?php if (isset($content['field_part_documentation'])) : ?>
                <li>
                  ...
                  <div class="accordion-panel">
                    <?php print render($content['field_part_documentation']); ?>
                  </div>
                </li>
              <?php endif; ?>
            </ul>
      ...
      <?php if ($field_part_bg_triangle['und'][0]['value']): ?>
    ...
    <section id="related">
      <div class="l--constrained clearfix">
        <?php if (isset($content['field_part_learning_links'])) : ?>
          <div class="section--primary">
            <div class="callout learn-with-community">
              <h3 class="callout-title"><?php print t('Learn with the Community'); ?></h3>
                <div class="link--list">
                  <?php print render($content['field_part_learning_links']); ?>
                </div>
            </div>
          </div>
        <?php endif; ?>
        <div class="section--secondary">
          <?php if (isset($content['field_part_related_products'])) : ?>

            <h4><?php print t('Related Products'); ?></h4>
            <div class="field--field_part_related_products related-products product-reference-2">
              <?php print render($content['field_part_related_products']); ?>
            </div>
          <?php endif; ?>
        </div>
      </div>
    ...
    <?php if (
      isset($content['field_part_video_title']) ||
      isset($content['field_part_video_description']) ||
      isset($content['field_part_video'])
    ): ?>
      <section id="video" class="feature product-section <?php if (isset($video_classes)) { print $video_classes; } ?>">
        ...
        <div class="l--constrained">
          <div class="section-primary">
            <?php if (isset($content['field_part_video_title'])) : ?>
              <div class="field--item field--field_part_video_title heading--large">
                <?php print render($content['field_part_video_title']); ?>
              </div>
            <?php endif; ?>

            <?php if (isset($content['field_part_video_description'])) : ?>
              <div class="field--item field--field_part_video_description">
                <?php print render($content['field_part_video_description']); ?>
              </div>
            <?php endif; ?>
          </div>
          <?php if (isset($content['field_part_video'])) : ?>
            <div class="section-secondary">
              <div class="field--item field--field_part_video">
                <?php print render($content['field_part_video']); ?>
              </div>
            </div>
          <?php endif; ?>
        </div>
    ...
    <section id="reviews" class="product-section l--constrained">
      ...
      <?php if (isset($content['field_product_reference']) || isset($content['field_part_images'])) : ?>
      <div class="section--primary">
      ...
      <?php if (isset($content['field_part_reviews'])) : ?>
        <div class="section--secondary">
          ...
          <div class="field--item field--field_part_reviews">
            <?php print render($content['field_part_reviews']); ?>
          </div>
        </div>
      <?php endif; ?>
    </section>
